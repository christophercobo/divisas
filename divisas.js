...
var clientes = [
    ...
    {tipo_documento: 'RUC', numero_documento: '98765432', nombre_completo: 'Maria Gomez'},
    {tipo_documento: 'PAS', numero_documento: '87654321', nombre_completo: 'Carlos Sanchez'}
];
...
var tasas = [
    {codigo_moneda: 'USD', nombre_moneda: 'Dólar Americano', tasa_compra: 3.5, tasa_venta: 3.7},
    {codigo_moneda: 'EUR', nombre_moneda: 'Euro', tasa_compra: 4.0, tasa_venta: 4.2},
    {codigo_moneda: 'GBP', nombre_moneda: 'Libra Esterlina', tasa_compra: 4.5, tasa_venta: 4.7}
];

// Días hábiles
var dias_habiles = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
...
function validarDiaHabil() {
    var fecha = new Date();
    var diaSemana = fecha.toLocaleString('en-us', {weekday: 'long'});
